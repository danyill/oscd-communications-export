...
:plugin-name: Communications Export
:sectnums:
:sectlinks:
:toc:
...
:uri-plugin: https://github.com/danyill/oscd-communications-export
:uri-ci-bundle: https://danyill.github.io/oscd-communications-export/oscd-communications-export.js
:uri-material-icons: https://fonts.google.com/icons
:uri-openscd-core-plugin-demo: https://danyill.github.io/oscd-communications-export/index.deploy.html

== What is this?

This plugin is intended to allow a user to export the Communication section of an SCL file.
...
For a local resource, begins without a forward slash, e.g. `plugins/oscd-communications-export/dist/oscd-communications-export.js`. 
...
----
{
  ...
  "active": true, // <.>
  "requireDoc": true, // <.>
  "src": "/dist/oscd-communications-export.js" // <.>
}
----
<.> Name of the plugin which appears in the editor menu at top of screen
...
<.> Whether a document must be loaded for this plugin to be available
<.> URL which can be a local or remote resource. 
For a local resource, begins with a forward slash, e.g. `plugins/oscd-communications-export/dist/oscd-communications-export.js`. 
